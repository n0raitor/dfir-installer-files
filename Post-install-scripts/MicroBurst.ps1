...
if (Test-Path -Path "C:\DFIR\MicroBurst") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Offensive\MicroBurst" -ItemType SymbolicLink -Target "C:\DFIR\MicroBurst" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\MicroBurst"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Offensive\MicroBurst" -ItemType SymbolicLink -Target "C:\DFIR\MicroBurst\MicroBurst.exe" -Force
