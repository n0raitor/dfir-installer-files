...
if (Test-Path -Path "C:\DFIR\WebDeploy") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Other\WebDeploy" -ItemType SymbolicLink -Target "C:\DFIR\WebDeploy" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\WebDeploy"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Other\WebDeploy" -ItemType SymbolicLink -Target "C:\DFIR\WebDeploy\WebDeploy.exe" -Force
