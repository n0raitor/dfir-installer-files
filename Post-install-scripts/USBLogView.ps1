...
if (Test-Path -Path "C:\DFIR\USBLogView") {
    ...
    New-Item -Path "C:\DFIR\_Tools\USB Forensics\USBLogView" -ItemType SymbolicLink -Target "C:\DFIR\USBLogView" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\USBLogView"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\USB Forensics\USBLogView" -ItemType SymbolicLink -Target "C:\DFIR\USBLogView\USBLogView.exe" -Force
