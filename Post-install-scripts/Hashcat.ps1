...
if (Test-Path -Path "C:\DFIR\Hashcat") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Offensive\Hashcat" -ItemType SymbolicLink -Target "C:\DFIR\Hashcat" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\Hashcat"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Offensive\Hashcat" -ItemType SymbolicLink -Target "C:\DFIR\Hashcat\Hashcat.exe" -Force
