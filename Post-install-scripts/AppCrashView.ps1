...
if (Test-Path -Path "C:\DFIR\AppCrashView") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Other\AppCrashView" -ItemType SymbolicLink -Target "C:\DFIR\AppCrashView" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\AppCrashView"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Other\AppCrashView" -ItemType SymbolicLink -Target "C:\DFIR\AppCrashView\AppCrashView.exe" -Force
