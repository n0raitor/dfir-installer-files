...
if (Test-Path -Path "C:\DFIR\Etcher") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Media\Etcher" -ItemType SymbolicLink -Target "C:\DFIR\Etcher" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\Etcher"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Media\Etcher" -ItemType SymbolicLink -Target "C:\DFIR\Etcher\Etcher.exe" -Force
