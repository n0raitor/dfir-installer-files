...
if (Test-Path -Path "C:\DFIR\FOR508VM-Soft") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Misc\FOR508VM-Soft" -ItemType SymbolicLink -Target "C:\DFIR\FOR508VM-Soft" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\FOR508VM-Soft"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Misc\FOR508VM-Soft" -ItemType SymbolicLink -Target "C:\DFIR\FOR508VM-Soft\FOR508VM-Soft.exe" -Force
