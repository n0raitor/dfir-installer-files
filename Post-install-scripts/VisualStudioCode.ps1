...
if (Test-Path -Path "C:\DFIR\VisualStudioCode") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Dev\VisualStudioCode" -ItemType SymbolicLink -Target "C:\DFIR\VisualStudioCode" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\VisualStudioCode"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Dev\VisualStudioCode" -ItemType SymbolicLink -Target "C:\DFIR\VisualStudioCode\VisualStudioCode.exe" -Force
