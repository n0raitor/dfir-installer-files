...
if (Test-Path -Path "C:\DFIR\CSVFileView") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Other\CSVFileView" -ItemType SymbolicLink -Target "C:\DFIR\CSVFileView" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\CSVFileView"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Other\CSVFileView" -ItemType SymbolicLink -Target "C:\DFIR\CSVFileView\CSVFileView.exe" -Force
