...
if (Test-Path -Path "C:\DFIR\Hasleo-Backup-Suite") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Backup\Hasleo-Backup-Suite" -ItemType SymbolicLink -Target "C:\DFIR\Hasleo-Backup-Suite" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\Hasleo-Backup-Suite"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Backup\Hasleo-Backup-Suite" -ItemType SymbolicLink -Target "C:\DFIR\Hasleo-Backup-Suite\Hasleo-Backup-Suite.exe" -Force
