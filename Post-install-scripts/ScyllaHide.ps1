...
if (Test-Path -Path "C:\DFIR\ScyllaHide") {
    ...
    New-Item -Path "C:\DFIR\_Tools\OSINT\ScyllaHide" -ItemType SymbolicLink -Target "C:\DFIR\ScyllaHide" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\ScyllaHide"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\OSINT\ScyllaHide" -ItemType SymbolicLink -Target "C:\DFIR\ScyllaHide\ScyllaHide.exe" -Force
