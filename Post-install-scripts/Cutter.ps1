...
if (Test-Path -Path "C:\DFIR\Cutter") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Utilities\Cutter" -ItemType SymbolicLink -Target "C:\DFIR\Cutter" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\Cutter"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Utilities\Cutter" -ItemType SymbolicLink -Target "C:\DFIR\Cutter\Cutter.exe" -Force
