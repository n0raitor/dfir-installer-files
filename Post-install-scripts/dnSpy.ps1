...
if (Test-Path -Path "C:\DFIR\dnSpy") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Malware Analysis\dnSpy" -ItemType SymbolicLink -Target "C:\DFIR\dnSpy" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\dnSpy"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Other\dnSpy" -ItemType SymbolicLink -Target "C:\DFIR\dnSpy\dnSpy.exe" -Force
