...
if (Test-Path -Path "C:\DFIR\UI.Xaml2.8") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Frameworks\UI.Xaml2.8" -ItemType SymbolicLink -Target "C:\DFIR\UI.Xaml2.8" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\UI.Xaml2.8"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Frameworks\UI.Xaml2.8" -ItemType SymbolicLink -Target "C:\DFIR\UI.Xaml2.8\UI.Xaml2.8.exe" -Force
