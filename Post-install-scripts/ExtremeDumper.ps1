...
if (Test-Path -Path "C:\DFIR\ExtremeDumper") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Malware Analysis\ExtremeDumper" -ItemType SymbolicLink -Target "C:\DFIR\ExtremeDumper" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\ExtremeDumper"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\SRE\ExtremeDumper" -ItemType SymbolicLink -Target "C:\DFIR\ExtremeDumper\ExtremeDumper.exe" -Force
