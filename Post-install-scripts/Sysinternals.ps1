...
if (Test-Path -Path "C:\DFIR\Sysinternals") {
    ...
    New-Item -Path "C:\DFIR\_Tools\System Utilities\Sysinternals" -ItemType SymbolicLink -Target "C:\DFIR\Sysinternals" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\Sysinternals"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\System Utilities\Sysinternals" -ItemType SymbolicLink -Target "C:\DFIR\Sysinternals\Sysinternals.exe" -Force
