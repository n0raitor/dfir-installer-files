...
if (Test-Path -Path "C:\DFIR\Mimikatz") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Offensive\Mimikatz" -ItemType SymbolicLink -Target "C:\DFIR\Mimikatz" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\Mimikatz"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Offensive\Mimikatz" -ItemType SymbolicLink -Target "C:\DFIR\Mimikatz\Mimikatz.exe" -Force
