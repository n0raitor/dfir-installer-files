...
if (Test-Path -Path "C:\DFIR\DNSLookupView") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Other\DNSLookupView" -ItemType SymbolicLink -Target "C:\DFIR\DNSLookupView" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\DNSLookupView"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Other\DNSLookupView" -ItemType SymbolicLink -Target "C:\DFIR\DNSLookupView\DNSLookupView.exe" -Force
