...
if (Test-Path -Path "C:\DFIR\hindsight") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Browser Tools\hindsight" -ItemType SymbolicLink -Target "C:\DFIR\hindsight" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\hindsight"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Browser Tools\hindsight" -ItemType SymbolicLink -Target "C:\DFIR\hindsight\hindsight.exe" -Force
