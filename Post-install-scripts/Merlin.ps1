...
if (Test-Path -Path "C:\DFIR\Merlin") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Offensive\Merlin" -ItemType SymbolicLink -Target "C:\DFIR\Merlin" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\Merlin"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Offensive\Merlin" -ItemType SymbolicLink -Target "C:\DFIR\Merlin\Merlin.exe" -Force
