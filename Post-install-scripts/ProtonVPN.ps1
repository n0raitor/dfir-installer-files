...
if (Test-Path -Path "C:\DFIR\ProtonVPN") {
    ...
    New-Item -Path "C:\DFIR\_Tools\System Utilities\ProtonVPN" -ItemType SymbolicLink -Target "C:\DFIR\ProtonVPN" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\ProtonVPN"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\System Utilities\ProtonVPN" -ItemType SymbolicLink -Target "C:\DFIR\ProtonVPN\ProtonVPN.exe" -Force
