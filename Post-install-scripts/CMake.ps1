...
if (Test-Path -Path "C:\DFIR\CMake") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Dev\CMake" -ItemType SymbolicLink -Target "C:\DFIR\CMake" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\CMake"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Dev\CMake" -ItemType SymbolicLink -Target "C:\DFIR\CMake\CMake.exe" -Force
