...
if (Test-Path -Path "C:\DFIR\forensicsim") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Browser Tools\forensicsim" -ItemType SymbolicLink -Target "C:\DFIR\forensicsim" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\forensicsim"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Browser Tools\forensicsim" -ItemType SymbolicLink -Target "C:\DFIR\forensicsim\forensicsim.exe" -Force
