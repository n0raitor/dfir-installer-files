...
# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Other\Google-Analytic-Cookie-Cruncher" -ItemType SymbolicLink -Target "C:\DFIR\Google-Analytic-Cookie-Cruncher\Google-Analytic-Cookie-Cruncher.exe" -Force
