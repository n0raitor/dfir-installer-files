...
if (Test-Path -Path "C:\DFIR\FOR500VM-Soft") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Misc\FOR500VM-Soft" -ItemType SymbolicLink -Target "C:\DFIR\FOR500VM-Soft" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\FOR500VM-Soft"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Misc\FOR500VM-Soft" -ItemType SymbolicLink -Target "C:\DFIR\FOR500VM-Soft\FOR500VM-Soft.exe" -Force
