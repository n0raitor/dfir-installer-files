...
if (Test-Path -Path "C:\DFIR\Chrome") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Browser\Chrome" -ItemType SymbolicLink -Target "C:\DFIR\Chrome" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\Chrome"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Browser\Chrome" -ItemType SymbolicLink -Target "C:\DFIR\Chrome\Chrome.exe" -Force
