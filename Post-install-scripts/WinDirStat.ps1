...
if (Test-Path -Path "C:\DFIR\WinDirStat") {
    ...
    New-Item -Path "C:\DFIR\_Tools\System Utilities\WinDirStat" -ItemType SymbolicLink -Target "C:\DFIR\WinDirStat" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\WinDirStat"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\System Utilities\WinDirStat" -ItemType SymbolicLink -Target "C:\DFIR\WinDirStat\WinDirStat.exe" -Force
