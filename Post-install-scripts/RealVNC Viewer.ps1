...
if (Test-Path -Path "C:\DFIR\RealVNC Viewer") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Other\RealVNC Viewer" -ItemType SymbolicLink -Target "C:\DFIR\RealVNC Viewer" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\RealVNC Viewer"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Other\RealVNC Viewer" -ItemType SymbolicLink -Target "C:\DFIR\RealVNC Viewer\RealVNC Viewer.exe" -Force
