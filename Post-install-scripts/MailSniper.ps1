...
if (Test-Path -Path "C:\DFIR\MailSniper") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Offensive\MailSniper" -ItemType SymbolicLink -Target "C:\DFIR\MailSniper" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\MailSniper"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Offensive\MailSniper" -ItemType SymbolicLink -Target "C:\DFIR\MailSniper\MailSniper.exe" -Force
